...
{\bfseries\MakeUppercase{PENGEMBANGAN SIMULASI INTERAKTIF BERLEVEL BERBASIS FINGER TRACKING MEDIAPIPE DENGAN MEKANISME HUMAN-IN-THE-LOOP PADA SISTEM LITERASI KECERDASAN BUATAN UNTUK SISWA SMP}}
...
{\large \bfseries FARCHAN DEANO MUHAMMAD}

\vspace{0.2cm}

{\large NRP. 3122520005}
...
{\large Dr. Tri Budi Santoso, S.T., M.T.}\\
{\large NIP. 197001051995021001}

\vspace{1.5cm}

{\large \bfseries PROGRAM STUDI SARJANA TERAPAN TEKNOLOGI REKAYASA MULTIMEDIA}\\
{\large \bfseries JURUSAN TEKNOLOGI MULTIMEDIA KREATIF}\\
{\large \bfseries POLITEKNIK ELEKTRONIKA NEGERI SURABAYA}\\
{\large \bfseries 2026}
...
{\bfseries\large HALAMAN PENGESAHAN}\\
{\bfseries\large PROPOSAL PROYEK AKHIR}
...
\begin{tabular}{lcl}
& & \\
\textbf{Dosen Pembimbing 1:} & & \textbf{Dosen Pembimbing 2:} \\[0.3cm]
Dr. Tri Budi Santoso, S.T., M.T. & & [Nama Pembimbing 2] \\
NIP. 197001051995021001 & & NIP. [Isi NIP] \\[1cm]
& & \\
\underline{\hspace{4cm}} & & \underline{\hspace{4cm}} \\[0.2cm]
...
{\bfseries POLITEKNIK ELEKTRONIKA NEGERI SURABAYA}\\
{\bfseries 2026}
...
\begin{itemize}
\item HALAMAN COVER \hfill i
\item HALAMAN PENGESAHAN \hfill ii
\item DAFTAR ISI \hfill iii
\item DAFTAR GAMBAR \hfill iv
\item DAFTAR TABEL \hfill v
\item BAB 1 PENDAHULUAN \hfill 1
  \begin{itemize}
  \item 1.1 Latar Belakang \hfill 1
  \item 1.2 Permasalahan \hfill 4
  \item 1.3 Batasan Masalah \hfill 5
  \item 1.4 Tujuan \hfill 6
  \item 1.5 Manfaat \hfill 6
  \item 1.6 Sistematika Penulisan \hfill 7
  \end{itemize}
\item BAB 2 KAJIAN PUSTAKA \hfill 8
  \begin{itemize}
  \item 2.1 Deskripsi Permasalahan \hfill 8
  \item 2.2 Teori Penunjang \hfill 9
  \item 2.3 Penelitian Terkait \hfill 18
  \end{itemize}
\item BAB 3 DESKRIPSI SISTEM \hfill 22
  \begin{itemize}
  \item 3.1 Deskripsi Solusi \hfill 22
  \item 3.2 Desain Sistem \hfill 24
  \item 3.3 Jadwal Penelitian \hfill 42
  \end{itemize}
\item DAFTAR PUSTAKA \hfill 44
\end{itemize}
...
\begin{itemize}
\item Gambar 2.1 Skema Konsep Literasi KB (Ng et al.) \hfill 9
\item Gambar 2.2 Tiga Peran HITL \hfill 11
\item Gambar 3.1 Alur Pengguna Global \hfill 26
\item Gambar 3.2 Use Case Diagram \hfill 27
\item Gambar 3.3 Alur Pengguna Level 1 \hfill 30
\item Gambar 3.4 Alur Pengguna Level 2 \hfill 33
\item Gambar 3.5 Alur Pengguna Level 3 \hfill 36
\item Gambar 3.6 Mekanisme HITL \hfill 38
\item Gambar 3.7 Alur Pemetaan Perilaku Objek \hfill 39
\item Gambar 3.8 Wireframe Onboarding \hfill 40
\item Gambar 3.9 Wireframe Main Gameplay \hfill 41
\item Gambar 3.10 Wireframe Probe UI \hfill 42
\item Gambar 3.11 Wireframe Result dan Feedback \hfill 43
\end{itemize}
...
\begin{itemize}
\item Tabel 2.1 Perbandingan State of The Art \hfill 20
\item Tabel 3.1 Kebutuhan Pengguna dan Prinsip Akademis Pendukung \hfill 25
\item Tabel 3.2 Spesifikasi Teknis Level 1 \hfill 29
\item Tabel 3.3 Spesifikasi Teknis Level 2 \hfill 32
\item Tabel 3.4 Spesifikasi Teknis Level 3 \hfill 35
\item Tabel 3.5 Pemetaan Label ke Perilaku Objek dan Konsekuensi Gameplay \hfill 38
\item Tabel 3.6 Metrik Pengujian Berbasis Perilaku \hfill 44
\item Tabel 3.7 Jadwal Penelitian \hfill 46
\end{itemize}
...
Perkembangan kecerdasan buatan telah membawa perubahan besar dalam cara manusia memperoleh informasi, menggunakan teknologi, dan mengambil keputusan. Teknologi ini tidak hanya digunakan dalam bidang industri, tetapi juga mulai memasuki kehidupan sehari-hari masyarakat, termasuk dunia pendidikan. Di sisi lain, pemahaman masyarakat terhadap cara kerja kecerdasan buatan masih belum merata. Banyak pengguna yang menerima keluaran sistem tanpa mempertimbangkan proses, kemungkinan kesalahan, maupun tingkat keyakinan sistem terhadap hasil yang diberikan [1].

Literasi kecerdasan buatan tidak cukup dipahami sebagai kemampuan mengenal istilah atau menggunakan aplikasi berbasis kecerdasan buatan. Literasi tersebut juga mencakup kemampuan memahami bagaimana sistem bekerja, mengevaluasi keluaran, dan mempertimbangkan dampak penggunaannya [1]. Dalam konteks pendidikan K-12, pembelajaran kecerdasan buatan membutuhkan strategi yang sesuai dengan perkembangan usia siswa, konteks sekolah, dan bentuk pengalaman belajar yang digunakan [2].

Salah satu tantangan dalam pembelajaran kecerdasan buatan adalah sifat konsepnya yang cenderung abstrak. Konsep seperti prediksi, tingkat keyakinan sistem, validasi, dan pengambilan keputusan tidak segera dapat dipahami oleh siswa hanya melalui penjelasan tekstual. Kondisi ini menunjukkan perlunya media yang mampu menyajikan pengalaman interaktif, memperlihatkan hubungan antara input pengguna, keluaran sistem, keputusan manusia, dan konsekuensi yang terjadi setelah keputusan tersebut diambil [2].

Pendekatan Explainable Artificial Intelligence dalam pendidikan menekankan pentingnya transparansi dan penyajian keluaran sistem yang dapat dipahami oleh pengguna [3]. Dalam konteks pembelajaran siswa SMP, explainability perlu diwujudkan dalam bentuk yang konkret dan sesuai dengan kemampuan kognitif siswa, misalnya melalui tampilan prediksi alternatif dan nilai tingkat keyakinan yang dapat dibaca.

Pendekatan Human-in-the-Loop menjadi relevan karena menempatkan manusia sebagai bagian dari proses sistem, baik sebagai pengamat, pengoreksi, validator, maupun pengambil keputusan [4]. Pada konteks pembelajaran, pendekatan ini memungkinkan siswa tidak hanya menerima keluaran sistem, tetapi juga mengevaluasi dan mengambil keputusan terhadap hasil tersebut. Keterlibatan manusia dalam proses sistem dapat memperkuat kontrol dan membangun kesadaran terhadap batasan kecerdasan buatan [5].

Untuk siswa SMP, penyampaian konsep tersebut membutuhkan media yang konkret, visual, dan bertahap. Media berbasis simulasi interaktif dapat membantu siswa mengalami proses belajar secara langsung melalui eksplorasi, percobaan, dan umpan balik. Simulasi berlevel memungkinkan pengalaman belajar disusun secara bertahap, dari pemahaman dasar menuju evaluasi yang lebih kompleks [6].

Simulasi interaktif yang dikembangkan pada proyek akhir ini menggunakan konsep visual berbasis buku sketsa. Konsep tersebut dipilih karena aktivitas menggambar dekat dengan proses eksplorasi visual dan kreatif yang dimiliki siswa SMP. Melalui interaksi berbasis finger tracking menggunakan MediaPipe, siswa dapat menggambar objek secara natural menggunakan gerakan jari di depan kamera [9]. Gambar yang dihasilkan kemudian diklasifikasi oleh sistem dan ditampilkan sebagai prediksi beserta tingkat keyakinannya.

Selain interaksi berbasis gerakan, sistem ini juga menggunakan mekanisme Human-in-the-Loop dalam simulasi berlevel. Pada setiap proses interaksi, siswa tidak hanya menjalankan simulasi, tetapi juga diminta membaca hasil prediksi, mempertimbangkan tingkat keyakinan sistem, dan menentukan keputusan. Keputusan tersebut kemudian menghasilkan konsekuensi pada simulasi sehingga konsep evaluasi terhadap keluaran sistem menjadi lebih konkret dan dapat diamati [4].

Pengembangan sistem ini diharapkan dapat menjadi media pembelajaran literasi kecerdasan buatan yang lebih visual, interaktif, dan sesuai untuk siswa SMP. Sistem tidak ditujukan sebagai produk permainan kompetitif, melainkan sebagai ruang eksplorasi untuk memahami hubungan antara prediksi sistem, keputusan pengguna, dan konsekuensi interaktif.

\section{PERMASALAHAN}
\label{sec:permasalahan}

Sistem kecerdasan buatan dalam pembelajaran sering kali dipahami sebagai alat yang memberikan jawaban akhir, sehingga pengguna berpotensi menerima keluaran sistem tanpa mempertimbangkan proses, tingkat keyakinan, maupun kemungkinan kesalahan. Pada tingkat SMP, konsep seperti prediksi, confidence, koreksi, validasi, dan pengambilan keputusan masih dapat terasa abstrak apabila hanya disampaikan melalui teks atau penjelasan satu arah. Kondisi ini menunjukkan adanya kebutuhan terhadap media berbasis teknologi yang mampu menyajikan pengalaman interaktif, memperlihatkan hubungan antara input pengguna, keluaran sistem, keputusan manusia, dan konsekuensi yang terjadi setelah keputusan tersebut diambil. Oleh karena itu, diperlukan pengembangan simulasi interaktif berlevel berbasis finger tracking MediaPipe dengan mekanisme Human-in-the-Loop agar siswa dapat memahami peran manusia dalam proses pengamatan, koreksi, validasi, dan pengambilan keputusan pada sistem kecerdasan buatan.

\section{BATASAN MASALAH}
\label{sec:batasan-masalah}

\begin{enumerate}
    \item Penelitian ini dibatasi pada pengembangan prototype simulasi interaktif berlevel berbasis web untuk mendukung literasi kecerdasan buatan bagi siswa SMP kelas 7 sampai 9.
    \item Sistem berfokus pada perancangan antarmuka, alur interaksi, finger tracking berbasis kamera menggunakan MediaPipe, mekanisme Human-in-the-Loop, dan umpan balik sistem.
    ...
    \item Penelitian ini tidak berfokus pada pengembangan model kecerdasan buatan kompleks, pelatihan ulang model, optimasi arsitektur model, maupun penerapan Human-in-the-Loop sebagai sistem produksi industri.
    \item Simulasi yang dikembangkan tidak difokuskan pada unsur gamifikasi atau fitur game lanjutan seperti multiplayer, leaderboard, badge, sistem skor kompetitif, level procedural, adaptive difficulty, chatbot, Large Language Model, Retrieval-Augmented Generation, maupun Natural Language Processing. Pengujian difokuskan pada fungsi sistem, keterbacaan alur interaksi, dan usability awal, sehingga penelitian ini tidak menggunakan pre-test dan post-test sebagai evaluasi utama serta tidak mengklaim peningkatan kemampuan siswa secara kuantitatif.
\end{enumerate}

\section{TUJUAN}
\label{sec:tujuan}

Penelitian proyek akhir ini bertujuan untuk mengembangkan prototype simulasi interaktif berlevel berbasis web untuk mendukung literasi kecerdasan buatan pada siswa SMP dengan menggunakan finger tracking berbasis MediaPipe dan mekanisme Human-in-the-Loop.

Tujuan khusus penelitian ini adalah merancang alur interaksi yang memungkinkan siswa menggambar, membaca keluaran sistem, menentukan keputusan, dan melihat konsekuensi keputusan tersebut di dalam simulasi.

Penelitian ini juga bertujuan menguji kelayakan awal sistem dari sisi fungsi, keterbacaan alur interaksi, dan usability awal sebagai dasar pengembangan lebih lanjut.
...
\begin{enumerate}
    ...
    \item Bagi peneliti atau mahasiswa, penelitian ini dapat menjadi dasar pengembangan sistem edukasi berbasis interaksi natural, finger tracking, dan Human-in-the-Loop pada bidang multimedia interaktif.
    \item Bagi pengembangan media pembelajaran, proyek ini dapat memberikan contoh rancangan simulasi interaktif berlevel yang menggabungkan teknologi computer vision, antarmuka pengguna, dan konsep literasi kecerdasan buatan.
\end{enumerate}
...
\textbf{BAB 1 PENDAHULUAN:} memuat latar belakang, permasalahan, batasan masalah, tujuan, manfaat, dan sistematika penulisan.

\textbf{BAB 2 KAJIAN PUSTAKA:} memuat deskripsi permasalahan, teori penunjang mengenai literasi kecerdasan buatan, Human-in-the-Loop, explainable interface, simulasi interaktif berlevel, finger tracking, pedagogical agent, child-computer interaction, dan usability testing, serta penelitian terkait.

\textbf{BAB 3 DESKRIPSI SISTEM:} memuat deskripsi solusi, desain sistem yang mencakup kebutuhan pengguna, alur pengguna, use case, desain level, mekanisme Human-in-the-Loop, pemetaan perilaku objek, desain wireframe, rencana pengujian, dan jadwal penelitian.
...
\label{sec:deskripsi-permasalahan-bab2}
% ============================================================
...
\bibitem{ref2}
L. Casal-Otero, A. Catala, C. Fern\'andez-Morante, M.~C. Taboada, B. Cebreiro, and S. Barro, ``AI literacy in K-12: A systematic literature review,'' \textit{International Journal of STEM Education}, vol.~10, Art. no.~29, 2023, doi: 10.1186/s40594-023-00418-7.
...
\bibitem{ref4}
E. Mosqueira-Rey, E. Hern\'andez-Pereira, D. Alonso-R\'ios, J. Bobes-Bascaran, and A. Fern\'andez-Leal, ``Human-in-the-loop machine learning: A state of the art,'' \textit{Artificial Intelligence Review}, vol.~56, pp.~3005--3054, 2023, doi: 10.1007/s10462-022-10246-w.
...
\bibitem{ref6}
M. Videnovik, T. Vold, L. Kionig, A. Madevska Bogdanova, and V. Trajkovik, ``Game-based learning in computer science education: A scoping literature review,'' \textit{International Journal of STEM Education}, vol.~10, Art. no.~54, 2023, doi: 10.1186/s40594-023-00447-2.

\bibitem{ref7}
K. Chan, K. Wan, and V. King, ``Performance over enjoyment? Effect of game-based learning on learning outcome and flow experience,'' \textit{Frontiers in Education}, vol.~6, Art. no.~660376, 2021, doi: 10.3389/feduc.2021.660376.

\bibitem{ref8}
N.~L. Schroeder, R.~O. Davis, and E. Yang, ``Designing and learning with pedagogical agents: An umbrella review,'' \textit{Journal of Educational Computing Research}, vol.~62, no.~8, 2025, doi: 10.1177/07356331241288476.

\bibitem{ref9}
Y. Meng, H. Jiang, N. Duan, and H. Wen, ``Real-Time Hand Gesture Monitoring Model Based on MediaPipe's Registerable System,'' \textit{Sensors}, vol.~24, no.~19, Art. no.~6262, 2024, doi: 10.3390/s24196262.
