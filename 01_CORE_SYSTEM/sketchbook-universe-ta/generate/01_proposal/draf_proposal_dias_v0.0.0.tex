% ============================================================
% DRAF PROPOSAL PROYEK AKHIR — MUHAMMAD DIAS AL IZZAT
% Versi: v0.0.0
% Tanggal: 17 Juni 2026
% Project: Sketchbook Universe
% Scope: Backend / CNN MobileNet / K-Means / REST API / Admin Dashboard
% Format: PENS Standard (A4, 12pt TNR, 1.5 spacing, 4cm/3cm margin)
% 
% Compiled dari:
%   - bab1_dias_v1.tex (Bab 1 verbatim, selaras dengan Can)
%   - bab2_dias_v1.tex (Bab 2 ringkas)
%   - bab3_dias_v1.tex (Bab 3 detail, pivot 16/6/26 applied)
%   - daftar_pustaka_dias_v1.tex (29 refs)
% 
...
%   #4 Resize/Rotate buttons UI (scope Can)
...
\textbf{}\\[0.5cm]
\textbf{SKETCHBOOK UNIVERSE: KLASIFIKASI SKETSA BERBASIS CNN MOBILENET DAN ANALISIS POLA PERILAKU SISWA SMP DENGAN K-MEANS CLUSTERING}\\[0.5cm]
\textbf{SKETCHBOOK UNIVERSE: SKETCH CLASSIFICATION BASED ON CNN MOBILENET AND BEHAVIORAL PATTERN ANALYSIS OF JUNIOR HIGH SCHOOL STUDENTS USING K-MEANS CLUSTERING}\\[2cm]
...
\textbf{Muhammad Dias Al Izzat}\\[0.3cm]
\textbf{NRP: 5322600012}\\[2cm]
...
\textbf{SKETCHBOOK UNIVERSE: KLASIFIKASI SKETSA BERBASIS CNN MOBILENET DAN ANALISIS POLA PERILAKU SISWA SMP DENGAN K-MEANS CLUSTERING}\\[1cm]
\end{center}
Diajukan oleh:
\begin{itemize}
\item \textbf{Nama:} Muhammad Dias Al Izzat
\item \textbf{NRP:} 5322600012
